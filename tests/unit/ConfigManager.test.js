...
describe('ConfigManager', () => {
  ...
  describe('validateConfig', () => {
    ...
    it('应该拒绝缺少必需字段的配置', () => {
      ...
      expect(() => configManager.validateConfig(invalidConfig)).to.throw('缺少必需的配置项');
    });
    ...
    it('应该验证数值范围', () => {
      ...
      expect(() => configManager.validateConfig(invalidConfig)).to.throw('maxConcurrency 必须在 1-16 之间');
    });
    ...
    it('应该验证缓存TTL', () => {
      ...
      expect(() => configManager.validateConfig(invalidConfig)).to.throw('缓存TTL不能为负数');
    });
  });
