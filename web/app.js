...
class DependencyAnalyzerApp {
   ...
   */
  getAnalysisConfig() {
    const framework = document.querySelector(
      'input[name="framework"]:checked'
    ).value;
    const includeNodeModules =
      document.getElementById("includeNodeModules").checked;
  ...
  updateProgressStats(files, total) {
    ...
    if (this.analysisStartTime) {
      ...
      progressTime.textContent = `${minutes
        .toString()
  ...
  showAnalysisResults(result) {
    ...
    document.getElementById("orphanComponents").textContent =
      result.orphanComponents;
  ...
  saveSettings() {
    try {
      const settings = {
        ...
        defaultMaxDepth: parseInt(
          document.getElementById("defaultMaxDepth").value
        ),
   ...
   */
  resetSettings() {
    this.showModal("重置设置", "确定要重置所有设置为默认值吗？", () => {
  ...
  applySettings() {
    // 更新表单值
    document.getElementById("defaultFramework").value =
      this.settings.defaultFramework;
    document.getElementById("defaultMaxDepth").value =
      this.settings.defaultMaxDepth;
    document.getElementById("autoSaveReports").checked =
      this.settings.autoSaveReports;
    document.getElementById("theme").value = this.settings.theme;
    document.getElementById("showAnimations").checked =
      this.settings.showAnimations;
    document.getElementById("maxCacheSize").value = this.settings.maxCacheSize;
    document.getElementById("workerThreads").value =
      this.settings.workerThreads;
    document.getElementById("exportFormat").value = this.settings.exportFormat;
    document.getElementById("includeSourceMaps").checked =
      this.settings.includeSourceMaps;
